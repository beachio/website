...
$(window).load(function() { 
    ...
    $('#logo-icon').hover(function(){
        $('.js-geolocation').toggleClass('hide');
    });

}); 

$(document).ready(function() {
  loadWeather('Bournemouth',''); //@params location, woeid
});
...
function loadWeather(location, woeid) {
  $.simpleWeather({
    ...
    success: function(weather) {
      html = '<h2><i class="weather icon-'+weather.code+'"></i></h2>';
      // '+weather.temp+'&deg;'+weather.units.temp+'
      html += '<span class="weather-location rotate">'+weather.city+' <br/> '+weather.region+'</span>';
